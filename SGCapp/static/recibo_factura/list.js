        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/sgcapp/deleteReciboFactura/' + row.id + '/" type="button" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash-alt"></i></a>';
                    return buttons;
                }
            },
        ],
        ...
        $('#data tbody')
            .on('click', 'a[rel="details"]', function () {
                ...
                $('#tblDet').DataTable({
                    ...
                    columns: [
                        {"data": "comprobantes.id"},
                        {"data": "comprobantes.monto"},
                        {"data": "cheque.id"},
                        {"data": "cheque.monto"},
                    ],
                    columnDefs: [
