# Generated by Django 3.0.7 on 2020-08-18 21:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_caja', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='usuario caja')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comprobante_cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='SGCapp.Cliente', verbose_name='Cliente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cheque_recibo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SGCapp.Recibo', verbose_name='Recibo')),
            ],
            options={
                'verbose_name': 'Cheque',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('monto', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Monto')),
                ('anticipo_comprobante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SGCapp.Comprobante', verbose_name='Comprobante')),
                ('anticipo_recibo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SGCapp.Recibo', verbose_name='Recibo')),
            ],
            options={
                'ordering': [builtins.id],
            },
